...
func (in *PermissionClaim) DeepCopyInto(out *PermissionClaim) {
	*out = *in
	...
	if in.Subresources != nil {
		...
		*out = make([]SubresourceClaim, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *SubresourceClaim) DeepCopyInto(out *SubresourceClaim) {
	*out = *in
	if in.Verbs != nil {
		in, out := &in.Verbs, &out.Verbs
		*out = make([]string, len(*in))
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new SubresourceClaim.
func (in *SubresourceClaim) DeepCopy() *SubresourceClaim {
	if in == nil {
		return nil
	}
	out := new(SubresourceClaim)
	in.DeepCopyInto(out)
	return out
}
